...
$wgDBtype        = "sqlite";
$wgDBserver      = "";
$wgDBname        = "mw_wikifundi";
$wgDBuser        = "";
$wgDBpassword    = "";
$wgSQLiteDataDir = "/var/www/data";

// Password policies (restriction on password formats)
...
$wgUploadDirectory = "/var/www/data/images";

// custom contact and credit pages
...
// Math extension: URLs should be user-accessible
...
// user-facing URL, overridable via `URL` environ
$wgServer = "http://localhost/";
$wgCanonicalServer = "http://localhost";

// include custom configuration from content package
require_once("/var/www/data/LocalSettings.custom.php");

// append below any runtime overrides…
